...
\begin{frame}{SVMs}{Qué es una SVM}
  \begin{figure}[ht]
    \centering
    \tikzset{
      common/.style={
...
\begin{frame}{Resultados}
  \begin{equation*}
    ...
    & \text{\emph{Root Acc}} &=& \quad\frac{\text{\# nodos raíz correctos}}{\text{\# total de frases}} \\
...
\begin{frame}{Implementación}{Por Qué en \textsc{Scala}}
  \begin{columns}[onlytextwidth,c]
    ...
    \item Programación \alert{Funcional}.
    \item Sintaxis breve.
    \item Escalable.
    \end{itemize}
    \column{.5\textwidth}
