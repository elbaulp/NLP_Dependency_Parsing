...
\ctparttext{La memoria se organiza en cuatro partes.
  ...
  \ref{ch:algorithm} \ref{ch:impl} y \ref{ch:tests}). En ellos se introduce al
  ...
  Por último, la cuarta parte consta del \autoref{ch:eval}, en donde se exponen
  los resultados obtenidos, se comparan los resultados con el algoritmo original
  y se proponen trabajos futuros.}
...
\ctparttext{Esta parte del trabajo se centra en los pasos seguidos para el
  ...
  Por último, el \autoref{ch:tests} explica los distintos casos de prueba
  llevados a cabo.
}
