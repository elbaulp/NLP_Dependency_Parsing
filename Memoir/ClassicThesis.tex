...
\cleardoublepage
\ctparttext{
Entre otros elementos, y no necesariamente en este orden, la
introducción debe servir para contextualizar el trabajo
(explicando antecedentes importantes para el desarrollo
realizado y, en su caso, realizando un estudio del estado del
arte) y describir el problema entre manos, de forma que el
lector tenga desde este momento una idea clara del problema a
resolver o del producto a desarrollar, y una visión general de la
solución alcanzada. Se concluirá esta sección con el alcance de
la memoria, de tal manera que el lector pueda hacerse una idea
del contenido posterior de la misma.


Las principales fuentes consultadas deben ser citadas aquí.
}
\part{Motivación e Introducción}
