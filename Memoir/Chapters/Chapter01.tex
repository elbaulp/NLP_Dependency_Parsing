...
forma de diccionario \question{traducción literal de \emph{non-inflected
    dictionary form}}no-inflexible. Esta fase es análoga a la anterior
(\emph{stemming}) pero se realiza a través de una serie de pasos más rigurosos
que incorporan un análisis morfológico de cada palabra.
...
para problemas de \ac{NLP}, en esta sección se presenta una descripción genérica
de un \emph{pipeline} para un software concreto ---
\textsc{CoreNLP} \cite{Manning2014} ---
