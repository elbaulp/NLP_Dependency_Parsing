...
\begin{description}\label{sec:nlpfields}
  ...
  \item[Traducción automática:] Esta fue la principal área de investigación en
    ...
    \marginpar{Conocido como texto paralelo} lo cual permitió recopilar
  ...
  \item[SDS:] Los \acp{SDS}\marginpar{\ac{SDS}: Sistemas de Diálogo
    ...
    \item \ac{DM}\marginpar{\ac{DM}: Gestión del diálogo}, para determinar qué
      quiere el humano.
    \item Acciones para obtener la información o realizar la actividad
      solicitada.
    \item Síntesis \ac{TTS}\marginpar{Leer un texto por una máquina}, para
...
simples usando palabras, secuencias del \emph{\ac{POS}}\marginpar{\ac{POS}:
Categorías
...
contra, hay una gran cantidad de \acp{LRL} --\marginpar{\ac{LRL}: Idiomas de
