...
El lenguaje natural \unsure[fancyline]{no estoy seguro}%
se refiere a cualquier lenguaje hablado por un humano, (\eg Inglés, Castellano o
Chino). El \ac{NLP}\graffito{\acf{PNL}} es un campo de la ciencia de la
...
\begin{description}\label{sec:nlpfields}
  ...
  \item[Traducción automática:] Esta fue la principal área de investigación en
    ...
    \graffito{Conocido como texto paralelo} lo cual permitió recopilar
  ...
  \item[SDS:] Los \acp{SDS}\graffito{\ac{SDS}: Sistemas de Diálogo
