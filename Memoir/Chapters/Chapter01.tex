...
\enhancement{Conozco bien el concepto de esta palabra, pero no encuentro la
  adecuada traducción. ¿Sacrificios?. Podría poner, \emph{En función de qué
    ...
    otras}}\emph{trade-off} en función de cual se decida usar. Veamos algnos de
ellos.
...
restricción. Si bien es cierto, se deben respetar ciertas normas y protocolos
como las indicaciones del fichero
