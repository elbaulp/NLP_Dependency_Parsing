...
Chino). El \acfi{NLP}\acused{NLP}\graffito{\acf{PNL}} es un campo de la ciencia
...
\begin{figure}[h]
  \begin{dependency}[edge slant=4pt,label theme = simple]
...
\acfi{SO}\acused{SO}\graffito{\acfi{SO}: Orientación Semántica} de las frases
