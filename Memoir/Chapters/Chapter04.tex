...
%      \draw [thick,->] (n4) -- ++(1cm,0);
  ...
  \begin{subfigure}[b]{0.3\textwidth}
    \begin{tikzpicture}[node distance=1.2cm,]
      \node (n1) [notarget] {I\\PRP};
      \node (n2) [notarget, right of=n1] {saw\\VBD};
      \node (nn) [draw=none,right of=n2] {};
      \node (n3) [target, right of=nn] {girl\\NN};
      \node (n4) [target, below of=n3,anchor=north] {a\\DT};
      \draw [thick,->] (n4) -- (n3);
...
\begin{figure}[ht]
  ...
  \begin{subfigure}[b]{0.3\textwidth}
    \begin{tikzpicture}[node distance=1.2cm]
      ...
      \node (n4) [notarget, below of=n3,anchor=north] {a\\DT};
      \draw [thick,->] (n4) -- (n3);
    \end{tikzpicture}
    \caption{}
  \end{subfigure}
  ...
  \begin{subfigure}[b]{0.3\textwidth}
    \begin{tikzpicture}[node distance=1.2cm]
      \node (n1) [notarget] {I\\PRP};
      \node (n2) [target, right of=n1] {saw\\VBD};
      \node (n4) [target, below of=n2,anchor=north] {girl\\NN};
      \node (n3) [notarget, below of=n4,anchor=north] {a\\DT};
      \draw [thick,->] (n4) -- (n2);
      \draw [thick,->] (n3) -- (n4);
    \end{tikzpicture}
    \caption{}
